...
After reading:
1. Confirm your understanding: "I see X slides covering [topics]. I'll restructure these into the Decksmith format — keeping all your content but improving the layout and adding [1–2 interactive components where it makes sense]. Does that sound right?"
